...
function Listings() {
  ...
  return (
    <main className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white rounded shadow-lg border border-gray-200 p-6 mb-8 -mt-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {listings.map((listing) => (
            <div 
              ...
              className="bg-white rounded shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200 overflow-hidden group cursor-pointer"
            >
              {/* Image */}
              {listing.photos && listing.photos.length > 0 ? (
                ...
                <div className="h-48 bg-slate-700 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4">
                    <div className="bg-white/95 backdrop-blur-sm rounded px-3 py-2 border border-white/20">
