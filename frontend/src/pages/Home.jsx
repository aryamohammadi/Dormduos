      ...
      <section className="py-16 bg-gray-100">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-8 max-w-2xl mx-auto">
            <p className="text-yellow-800 text-sm leading-relaxed">
              <strong>Important:</strong> This platform facilitates connections between renters and landlords. All agreements, payments, and communications are between you and the property owner. Use caution and verify all details independently.
            </p>
          </div>
